...
#ifndef RESCUEBROADCAST_SWIFT_H
#define RESCUEBROADCAST_SWIFT_H
...
@interface CTTelephonyNetworkInfo (SWIFT_EXTENSION(RescueBroadcast))
@property (nonatomic, readonly, strong) CTCarrier * _Nullable carrier;
@end


SWIFT_CLASS("_TtC15RescueBroadcast13GroupDefaults")
@interface GroupDefaults : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC15RescueBroadcast21RescueBluetoothDevice")
@interface RescueBluetoothDevice : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface RescueBluetoothDevice (SWIFT_EXTENSION(RescueBroadcast)) <CBCentralManagerDelegate>
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
@end


SWIFT_CLASS("_TtC15RescueBroadcast23RescueDeviceViewManager")
@interface RescueDeviceViewManager : NSObject
- (void)startDeviceView;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC15RescueBroadcast28RescueScreenShareManagerBase")
@interface RescueScreenShareManagerBase : RescueDeviceViewManager
@end


SWIFT_CLASS("_TtC15RescueBroadcast22RescueBroadcastManager")
@interface RescueBroadcastManager : RescueScreenShareManagerBase
@end
...
@property (nonatomic) enum RescueSessionStatus sessionStatus;
...
@class RescueBroadcastChatMessage;
@class NSURL;

SWIFT_PROTOCOL_NAMED("RescueChatDelegate")
@protocol RescueBroadcastChatDelegate
@optional
- (void)rescueChatTyping;
- (void)rescueChatDidReceiveMessage:(RescueBroadcastChatMessage * _Nonnull)chatMessage;
...
@interface RescueBroadcastSession (SWIFT_EXTENSION(RescueBroadcast)) <RescueBroadcastChatDelegate>
@end
...
SWIFT_CLASS("_TtC15RescueBroadcast13RescueChannel")
@interface RescueChannel : NSObject
- (void)startSendLoop;
...
SWIFT_CLASS("_TtC15RescueBroadcast17RescueChannelItem")
@interface RescueChannelItem : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS_NAMED("RescueChat")
@interface RescueBroadcastChat : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15RescueBroadcast29RescueChatActionPacketHandler")
@interface RescueChatActionPacketHandler : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC15RescueBroadcast17RescueChatChannel")
@interface RescueChatChannel : RescueChannel
@end



SWIFT_CLASS("_TtC15RescueBroadcast17RescueChatManager")
@interface RescueChatManager : NSObject
- (void)startChat;
- (void)startTraffic;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS_NAMED("RescueChatMessage")
@interface RescueBroadcastChatMessage : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15RescueBroadcast30RescueChatMessagePacketHandler")
@interface RescueChatMessagePacketHandler : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC15RescueBroadcast12RescueSocket")
@interface RescueSocket : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC15RescueBroadcast19RescueControlSocket")
@interface RescueControlSocket : RescueSocket
@end


SWIFT_CLASS("_TtC15RescueBroadcast12RescueDevice")
@interface RescueDevice : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15RescueBroadcast29RescueDeviceViewPacketHandler")
@interface RescueDeviceViewPacketHandler : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS_NAMED("RescueDisplay")
@interface RescueBroadcastDisplay : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15RescueBroadcast13RescueGateway")
@interface RescueGateway : NSObject
- (void)enterLoop;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC15RescueBroadcast16RescueJSONLoader")
@interface RescueJSONLoader : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface RescueJSONLoader (SWIFT_EXTENSION(RescueBroadcast)) <NSURLSessionDataDelegate>
...
typedef SWIFT_ENUM(NSUInteger, RescueNetworkStatus, closed) {
  RescueNetworkStatusNotReachable = 0,
  RescueNetworkStatusReachableViaWiFi = 1,
  RescueNetworkStatusReachableViaWWAN = 2,
};


/// Pinger class
/// Periodically write ping message to the socket. Waiting for pong messages, if there is no pong message after 3 pings call the delegate with time out message.
SWIFT_CLASS("_TtC15RescueBroadcast10RescuePing")
@interface RescuePing : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC15RescueBroadcast18RescueReachability")
@interface RescueReachability : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC15RescueBroadcast34RescueScreenSharePacketHandlerBase")
@interface RescueScreenSharePacketHandlerBase : RescueDeviceViewPacketHandler
@end

@class NSDate;
@class NSCoder;

SWIFT_CLASS("_TtC15RescueBroadcast17RescueSessionData")
@interface RescueSessionData : NSObject
/// status of the session
@property (nonatomic) enum RescueSessionStatus status;
/// technician’s name
@property (nonatomic, copy) NSString * _Nullable operatorName;
/// unique identifier for the session
@property (nonatomic, copy) NSString * _Nullable sessionId;
/// original session start date
@property (nonatomic, copy) NSDate * _Nullable sessionStart;
/// gateway that handles the session
@property (nonatomic, copy) NSString * _Nullable selectedGatewayUrl;
/// parameters returned on session start // todo - do not use AnyObject?
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nullable params;
/// stored chat messages (including status messages)
@property (nonatomic, copy) NSArray * _Nonnull messages;
/// stored chat messages (only technician and client)
@property (nonatomic, copy) NSArray * _Nonnull chatMessages;
/// caller app’s url to redirect user after session end
@property (nonatomic, copy) NSString * _Nullable callbackUrl;
/// media stream state: paused
@property (nonatomic) BOOL paused;
/// microphone state: muted
@property (nonatomic) BOOL muted;
/// traffic - sent data on sockets
@property (nonatomic) size_t trafficSentSocket;
/// traffic - received data on sockets
@property (nonatomic) size_t trafficReceivedSocket;
/// traffic - sent data on streams
@property (nonatomic) size_t trafficSentStream;
/// traffic - received data on streams
@property (nonatomic) size_t trafficReceivedStream;
@property (nonatomic) BOOL forceDisableAudio;
...
@interface RescueSessionData (SWIFT_EXTENSION(RescueBroadcast)) <NSCoding>
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
@end


SWIFT_CLASS("_TtC15RescueBroadcast24RescueSessionInformation")
@interface RescueSessionInformation : RescueSessionData
/// media stream state: frozen
...
@interface RescueSocket (SWIFT_EXTENSION(RescueBroadcast)) <NSStreamDelegate>
